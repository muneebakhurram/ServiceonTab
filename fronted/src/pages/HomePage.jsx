...
import decore from '../assests/images/Rectangle_1.png';
        ...
        <div>
            ...
            <div className="quote-section">
                <div className="quote-contents">
                    <div className="texts">
                        <div className="frame">
                            <div className="why-our-customers">Why our customers choose us?</div>
                        </div>
                ...
                <div className="overlap">
                    <div className="about-contents">
                        <div className="texts">
                            ...
                            <div className="point">
                                <div className="div">
                                    <div className="frame-2"><div className="text-wrapper-2">Police Verified Experts</div></div>
                                    <div className="frame-2"><div className="text-wrapper-3">Verified Professionals</div></div>
                                    <div className="frame-4"><div className="text-wrapper-4">Quick Booking Process</div></div>
                                </div>
                                <div className="frame-5">
                                    <div className="frame-2"><div className="text-wrapper-5">User Friendly</div></div>
                                    <div className="frame-6"><div className="text-wrapper-6">Best Quality</div></div>
                                    <div className="frame-2"><div className="text-wrapper-6">Affordable Prices</div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p className="welcome-to-service">Welcome to Service on Tab – Your Trusted Home Services Provider!</p>
                </div>
            </div>
